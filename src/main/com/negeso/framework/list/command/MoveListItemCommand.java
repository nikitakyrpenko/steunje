/*
 * @(#)MoveListItemCommand.java       @version  18.02.2004
 *
...
public class MoveListItemCommand extends AbstractCommand {

	private static Logger logger = Logger.getLogger(MoveListItemCommand.class);
