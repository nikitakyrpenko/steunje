...
<html>
   <head>
    ...
    <title><fmt:message key="RS_PRODUCT_RICH_SNIPPETS"/></title>
...
<negeso:admin>
	...
	<table align="center"  border="0" cellpadding="0" cellspacing="0" class="admTable">
        ...
        <tr>                
			<td align="center" class="admNavPanelFont"  style="height:auto;" colspan="8"><fmt:message key="RS_PRODUCT_RICH_SNIPPETS" /></td>
		</tr>
		<tr> 
			<td class="admTDtitles" width="25%" style="height:auto"><fmt:message key="RS_REVIEW_NAME"/></td>
			<td class="admTDtitles" width="25%" style="height:auto"><fmt:message key="RS_PRODUCT_BRAND"/></td>
			<td class="admTDtitles" width="20%" style="height:auto"><fmt:message key="RS_PRODUCT_MODEL"/></td>
			<td class="admTDtitles" width="20%" style="height:auto"><fmt:message key="RS_PRODUCT_AVERAGE_RATING"/></td>
		...
		<c:forEach var="richSnippet" items="${richSnippets}">
			<tr>
				...
				<td class="admTableTD">                  
                    <c:out value="${richSnippet.brand}"></c:out>
                </td>
				<td class="admTableTD">                  
                    <c:out value="${richSnippet.model}"></c:out>
                </td>
				<td class="admTableTD">
                    <c:out value="${richSnippet.averageRating}"></c:out>
                </td>
