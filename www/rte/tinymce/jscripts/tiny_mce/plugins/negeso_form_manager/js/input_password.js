var InputPasswordDialog = {
	...
	init : function(ed) {
		...
		// Check action
		if (elm != null && elm.nodeName == 'INPUT' && ('' + dom.getAttrib(elm,'type')) == 'password')
			action = 'update';
...
tinyMCEPopup.onInit.add(InputPasswordDialog.init, InputPasswordDialog);