/*
 * @(#)MoveResourceFace.java       @version	21.03.2004
 *
...
/**
 * Get movee resource face command
 *
 * @version 	$Revision: 11$
...
public class GetMoveResourceFace extends AbstractCommand {
	private static Logger logger = Logger.getLogger(GetMoveResourceFace.class);
