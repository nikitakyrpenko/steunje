var InputRadioDialog = {
	...
	init : function(ed) {
		...
		// Check action
		if (elm != null && elm.nodeName == 'INPUT' && ('' + dom.getAttrib(elm,'type')) == 'radio')
			action = 'update';
...
function insertField() {
	...
	if (elm != null && elm.nodeName == "INPUT") {
		...
		if (tinyMCE.isOpera)
			html += makeAttrib('class', 'form_radio');
		html += " />";
...
tinyMCEPopup.onInit.add(InputRadioDialog.init, InputRadioDialog);