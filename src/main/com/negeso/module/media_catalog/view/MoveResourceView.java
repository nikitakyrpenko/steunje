/*
 * @(#)MoveResourceView.java       @version	21.03.2004
 *
...
/**
 * Move resource presentation.
 *
 * @version 	21.03.2004
 * @author 	Olexiy.Strashko
 */
public class MoveResourceView extends AbstractHttpView {
	...
	public static final String STYLE_SHEET = "MOVE_RESOURCE_XSL";
	...
	public void process(RequestContext request, ResponseContext response) {
		...
		// *********************************************************************
		// +++ rename file option
		page.add(CatalogXmlBuilder.get().getMoveResourceViewOptionDom4j(
