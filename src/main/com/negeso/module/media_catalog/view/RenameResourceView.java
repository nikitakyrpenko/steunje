/*
 * @(#)RenameResourceView.java       @version	21.03.2004
 *
...
/**
 * Rename resource presentation
 *
 * @version 	21.03.2004
 * @author 	Olexiy.Strashko
 */
public class RenameResourceView extends AbstractHttpView {
	
	private static Logger logger = Logger.getLogger(RenameResourceView.class);
	...
	public static final String STYLE_SHEET = "RENAME_RESOURCE_XSL";
	...
	public void process(RequestContext request, ResponseContext response) {
		...
		Resource resource = (Resource) resultMap.get(OUTPUT_RESOURCE);
		...
		// *********************************************************************
		// +++ rename file option
		page.add(CatalogXmlBuilder.get().getRenameResourceViewOptionDom4j(
			"Rename resource",
			resource
		));
		// - rename file option
