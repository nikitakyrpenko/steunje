...
<html>
   <head>
    ...
    <title><fmt:message key="RS_VIDEO_RICH_SNIPPETS"/></title>
...
<negeso:admin>
	...
	<table align="center"  border="0" cellpadding="0" cellspacing="0" class="admTable">
        ...
        <tr>                
			<td align="center" class="admNavPanelFont"  style="height:auto;" colspan="8"><fmt:message key="RS_VIDEO_RICH_SNIPPETS" /></td>
		</tr>
		<tr> 
			<td class="admTDtitles" width="20%" style="height:auto"><fmt:message key="RS_REVIEW_NAME"/></td>
			<td class="admTDtitles" width="20%" style="height:auto"><fmt:message key="RS_VIDEO_DURATION"/></td>
			<td class="admTDtitles" width="20%" style="height:auto"><fmt:message key="RS_VIDEO_UPLOAD_DATE"/></td>
			<td class="admTDtitles" width="20%" style="height:auto"><fmt:message key="RS_VIDEO_EXPIRED_DATE"/></td>
		...
		<c:forEach var="richSnippet" items="${richSnippets}">
			<tr>
				...
				<td class="admTableTD">                  
                    <c:out value="${richSnippet.duration}"></c:out>
                </td>
				<td class="admTableTD">
					<fmt:formatDate value="${richSnippet.uploadDate}" pattern="dd-MM-yyyy"/>
                </td>
				<td class="admTableTD">
					<fmt:formatDate value="${richSnippet.expires}" pattern="dd-MM-yyyy"/>
                </td>
