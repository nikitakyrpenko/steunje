/*
 * @(#)$Id: GetResourceInfoFace.java,v 1.7, 2007-02-19 09:20:05Z, Olexiy Strashko$
 *
...
/** 
 * Get Resource Info face (Page with full resource information)
 *
 * @version 	$Revision: 8$
...
public class GetResourceInfoFace extends AbstractCommand {
	private static Logger logger = Logger.getLogger(GetResourceInfoFace.class);
	...
	public ResponseContext execute() {
		...
		try{
			...
			Element resourceElement = resource.toDom4jElement(
			        request.getSession().getUser()
			);
			resourceElement.add(resource.getDependenciesDom4j());
			resultMap.put(OUTPUT_RESOURCE, resourceElement);
		}
		catch (CriticalException e) {
