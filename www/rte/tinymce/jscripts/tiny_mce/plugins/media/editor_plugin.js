...
(function() {
	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
		...
		dataToImg : function(data, force_absolute) {
			...
			var objectType = self.getType(data.type).name;
			if (objectType == 'Iframe' && data.params.src.indexOf('mapsengine') > 0) {
				objectType = "GoogleMap";
			}
			img = self.editor.dom.create('img', {
				...
				'class' : 'mceItemMedia mceItem' + objectType,
		...
		objectToImg : function(node) {
			...
			img.attr({
				id : id,
				'class' : 'mceItemMedia mceItem' + (objectType || 'Flash'),
				style : style,
