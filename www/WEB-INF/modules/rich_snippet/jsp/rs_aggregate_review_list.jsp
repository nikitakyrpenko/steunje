...
<html>
   <head>
    ...
    <title><fmt:message key="RS_AGGREGATE_REVIEW_RICH_SNIPPETS"/></title>
...
<negeso:admin>
	...
	<table align="center"  border="0" cellpadding="0" cellspacing="0" class="admTable">
        ...
        <tr>                
			<td align="center" class="admNavPanelFont"  style="height:auto;" colspan="8"><fmt:message key="RS_AGGREGATE_REVIEW_RICH_SNIPPETS" /></td>
		</tr>
		<tr> 
			...
			<td class="admTDtitles" width="20%" style="height:auto"><fmt:message key="RS_AGGREGATE_RATING_COUNT"/></td>
			<td class="admTDtitles" width="20%" style="height:auto"><fmt:message key="RS_AGGREGATE_REVIEW_COUNT"/></td>
		...
		<c:forEach var="richSnippet" items="${richSnippets}">
			<tr>
				...
				<td class="admTableTD">                  
                    <fmt:formatNumber pattern="###.##" value="${richSnippet.ratingValue}"/>
                </td>
				<td class="admTableTD">
					<c:out value="${richSnippet.ratingCount}"></c:out>
                </td>
				<td class="admTableTD">
					<c:out value="${richSnippet.reviewCount}"></c:out>
                </td>
